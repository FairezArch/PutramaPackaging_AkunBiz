...
$idkredit = secure_string($_GET['full_cicilan']);
...
$name_user = querydata_user($data_user,'nama');
...
<div class="wrap">   
    ...
    <div class="dataorder">
        <table class="stdtable">
            ...
            <tr>
                <td>Waktu Bayar</td>
                <td> : </td>
                <td><?php echo date('j F Y, H.i', $waktu_cicilan); ?></td>
            </tr>
        </table>
		<div class="clear"></div>
    </div>
    ...
    <div class="thanks">
        <div class="center">Terima kasih <?php echo $name_user; ?>!<br>
