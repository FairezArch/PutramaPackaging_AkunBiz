...
<title>Putrama Packaging Detail Produk</title>
...
<?php $mobidetect = new Mobile_Detect(); ?>   
    ...
    <div class="wrapper wrapheader-mobile">
    	<div class="headlist">
        	...
        	<h1 class="center"><a href="<?php echo GLOBAL_URL; ?>" title="Putrama Packaging"><img src="penampakan/images/logo-putrama.png" height="33" width="123"></a></h1>
    ...
    <div class="mobilepage">
		...
		<div class="contentutama">
            <?php
            if(isset($_GET['look']) && $_GET['look'] == 'product') {
              include "halaman/view_product.php";
            } else {
            header('location:../');
            }
            ?>
