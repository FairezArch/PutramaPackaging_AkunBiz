...
if ( isset($_GET['command']) ) { // format: 9_2016
	...
	$baseurl = "page=stock_product&viewstock=".$page_to."&datefrom=".$tgl_from."&dateto=".$tgl_to."&command=Go!";
} else {
...
<h2 class="topbar">Detail Stock</h2>
	<div class="tooltop" style="height: 34px;">
	    <div class="ltool">

           	<form method="get" name="thetop">
               	<input type="hidden" name="page" value="stock_product"/>
