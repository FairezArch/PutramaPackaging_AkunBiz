<?php if( is_admin() ){ 
	...
	if('office' == $get){
		...
		$title='Kantor';
		$alt ='Kantor';
	}elseif ('warehouse' == $get) {
		$type=2;
		$title='Gudang';
		$alt ='Gudang';
	}else{$type=0;}

	$data_inventory = table_inv($type);
?>
<div class="bloktengah" id="blokkategori">
    <div class="option_body kategori_body">
            <h2 class="topbar">Inventaris <?php echo $title;?></h2>
            ...
            <table class="dataTable" width="100%" border="0" id="datatable_inventaris">
	            ...
	            <tbody>
	            	...
	            	<tr id="inv_<?php echo $data['id']?>">
	            		...
	            		<td class="center"><?php if( $data['kd_barang'] != '' ){ echo $data['kd_barang']; }?></td>
	            		...
	            		<td><?php if( 1 == $data['aktif'] ) { if( 'min' == $data['fluktuasi_type'] ){ 
	            			echo "Menurun <br /><small> Nilai penurunan: ".uang($data['fluktuasi_val'])." Per bulan.<br /> Umur: ".inv_umur($data['id']).", max ".$data['inv_age']." tahun.</small>"; }else{ echo "Tetap";}
	            				...
	            				echo "Dibuang tanggal ".date('j M Y',$data['date']);
	            			} 
	            			?>
	            		</td>
	            		...
	            		<td class="center nowrap">
	            			...
	            			<?php } ?>
	            			<input type="hidden" id="kdbarang_<?php echo $data['id'];?>" value="<?php echo $data['kd_barang'];?>">
        ...
        <div class="popkat" id="pop_inventaris" style="width: 430px; top: 36%;">
        	<h3 style="padding-bottom: 5px;"><span id="titlepop">Tambah</span> Inventaris <?php echo $alt;?> <span id="titlepopid"></span></h3>
        	<table class="stdtable">
				...
				<tr>
					...
					<td>
						<select name="fluk_type" id="fluk_type" title="Menurun: misalnya komputer, meja, kursi, kendaraan." onchange="type_fluktuasi();">
        	...
        	<div class="submitarea">
		        ...
		        <input type="hidden" id="inv_type" value="<?php echo $type;?>" />
		        <input type="hidden" id="inv_status" value="0">
